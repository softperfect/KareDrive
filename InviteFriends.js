  ...
  render() {
    ...
    return (
      <View style={styles.containerMain}>
        <Image source={require('./img/email_icom.png')} style={styles.logoImage}/>
          <Text style={styles.headerDate2}>Share Your Invite Code</Text>
            <Text style={styles.headerDate3}>{global.referralNumber}</Text>



        <TouchableHighlight underlayColor='transparent'  onPress={this.onOpen.bind(this)}>
          <View style={styles.logoBackGround}>
            <Text style={styles.headerDate}>INVITE FRIENDS</Text>
          </View>
        </TouchableHighlight>
